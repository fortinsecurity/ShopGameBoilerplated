...
from ..database import users, database, inventory


# to get a string like this run:
# openssl rand -hex 32
SECRET_KEY = "09d25e094faa6ca2556c818166b7a9563b93f7099f6f0f4caa6cf63b88e8d3e3d"
ALGORITHM = "HS256"
...
async def get_user(username: str):
    ...
    try:
        ...
        print(dict(user))
        temp = UserOut(username=user["username"], hashed_password=user["hashed_password"], capital=user["capital"])
        print(temp)
        return temp
    except Exception as e:
        print(e)
